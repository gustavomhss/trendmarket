...
## Delivery Metadata
- Branch: `work`  
- Commit: `22f135c` / `bdd5a74`  
- Tag: `amm-error-hardening-2025-09-28` (ou ainda não criado em algumas execuções)  
- PR: https://github.com/credit-engine/trendmarket/pull/1234 (ou ainda não criado em algumas execuções)  
- Artifacts bundle:  
  - `/workspace/trendmarket/out/pkg/amm_error_hardening_artifacts_20250928-163903.zip`  
  - `/workspace/trendmarket/out/pkg/amm_error_hardening_artifacts_20250928-154532.zip`  
- Patches bundle:  
  - `/workspace/trendmarket/out/pkg/amm_error_hardening_patches_20250928-163903.zip`  
  - `/workspace/trendmarket/out/pkg/amm_error_hardening_patches_20250928-154532.zip`  
