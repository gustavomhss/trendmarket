...
# mantém portas definidas no .env (se houver)
...
# escreve YAML com indentação correta (2/4 espaços)
...
# imprime com numeração p/ auditoria visual (confira os espaços!)
nl -ba docker-compose.observability.yml | sed -n '1,160p'


# validação estrutural clara
