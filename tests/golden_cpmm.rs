...
//!
//! Adicionalmente, inclui um "golden set" de invariância do CPMM (fee=0) que verifica |Δk/k| ≤ 1e-9 usando Wad nos inputs
//! e U256 apenas para o produto invariante `k`.
...
// -------------------------------
// Golden set CPMM (fee=0) — invariância do produto k
// -------------------------------
#[inline]
fn w(n: &str) -> Wad {
