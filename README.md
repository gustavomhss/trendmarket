...
./scripts/obs_t3_prom_scrape_run.sh --config ops/prometheus/prometheus.dev.yml  --out out/obs_gatecheck
./scripts/obs_t3_prom_scrape_run.sh --config ops/prometheus/prometheus.prod.yml --out out/obs_gatecheck
